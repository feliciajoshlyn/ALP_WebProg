                ...
                if ($_SESSION['user']['admin'] == 0) {
                    ...
                    <div class="w-[90%] lg:w-[80%] mx-auto mb-2 flex justify-end">
                        <button onclick="location.href='cart.php'"
                            class="p-2 border border-blue-500 bg-blue-500 text-yellow-50 rounded-lg text-blue-300 hover:bg-white hover:text-blue-300 mr-2">View
                            Cart</button>
                    </div>
                    <?php
                }
                            ...
                            <div class="p-2 flex md:mx-1">
                                ...
                                <div class="ml-2 md:ml-4 md:text-right w-full p-1">
                                    ...
                                    if ($data['approved'] == 0 && $_SESSION['user']['admin'] == 1) {
                                        ?>
                                        <a href="itemApproval.php?request_id=<?= $data['request_id'] ?>&user_id=<?= $data['customer_id'] ?>"
                                            class=" text-xs text-red-300 hover:underline">approve item</a>
                                        <?php
