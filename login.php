        ...
        <div class="bg-[#FBEBA1] p-6 mt-32 rounded-lg shadow-md w-[90%] md:w-[40%] lg:w-[30%] mx-auto text-center flex flex-col mb-16">
            ...
            <div>
                <form class="flex flex-col justify-start items-start mt-4" method="POST" action="loginBehind.php">
                    Username<input type="text" name="username" class="w-full outline outline-offset-1 rounded-lg mb-4 pl-2 pb-1 pt-1" required>
                    Password<input type="password" name="password" class="w-full outline outline-offset-1 rounded-lg pl-2 pb-1 pt-1">
