        ...
        <div>
            ...
            <div class="flex flex-col items-center mt-16 md:mt-20 md:items-start md:w-full lg:w-full mx-auto p-4">
                <div class="w-full text-center md:text-left">
                    <button class="back-button <?php if ($_SESSION['user']['admin'] == 0) { ?>md:hidden <?php } ?>"
                ...
                <div class="w-[90%] lg:w-[80%] mx-auto mb-2 flex justify-end">
                    <button onclick="location.href='confirmedItems.php'"
                        class="p-2 border border-blue-500 bg-blue-500 text-yellow-50 rounded-lg text-blue-300 hover:bg-white hover:text-blue-300 mr-2">Confirmed
                        Items</button>
                </div>
                            ...
                            <div class="p-2 flex md:mx-1">
                                ...
                                <div class="ml-2 md:ml-4 md:text-right w-full p-1">
                                    ...
                                    if ($_SESSION['user']['admin'] == 0) {
                                        ...
                                        <a class="text-xs text-red-300 hover:underline"
                                            href="deleteCartItem.php?product_id=<?= $data['product_id'] ?>">Remove</a>
                                        <?php
                                    } else {
                                        ?>
                                        <span class="hidden md:inline mx-2 text-blue-300">|</span>
