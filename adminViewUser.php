                    ...
                    while ($data = $result->fetch_assoc()) {
                        ...
                        <div class="p-2 flex md:mx-1">
                            <div class="ml-2 md:ml-4 md:text-right w-full p-1">
                                ...
                                <p class="md:text-xs text-sm md:mb-1 md:block md:text-left ">Email: <?= $data['email'] ?>
                                </p>
                                <p class="md:text-xs text-sm md:mb-1 md:block md:text-left ">Phone:
                                    <?= $data['telephone_num'] ?></p>
                                ...
                                <a class="text-xs text-blue-300 hover:underline"
                                    href="confirmedItems.php?user_id=<?= $data['customer_id'] ?>">View Items</a><br
                                    class="md:hidden">
                            </div>
                        </div>
                        <hr class="mb-2">
